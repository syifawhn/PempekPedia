...
public class AdapterCard extends RecyclerView.Adapter<AdapterCard.CardViewHolder> {
    ...
    private ArrayList<ModelSaya> dataRestoran;
    private Context ctx;
    ...
    public AdapterCard(ArrayList<ModelSaya> data, AboutActivity ctx) {
        this.dataRestoran = dataRestoran;
        this.ctx = ctx;
    }
    ...
    @NonNull
    @Override
    public CardViewHolder onCreateHolder(@NonNull ViewGroup parent, int viewType) {
